...
def save_barcode_image(barcode, image_data):
    """حفظ صورة باركود محلياً"""
    try:
        ...
        filename = f"barcode_{barcode}_{timestamp}_{unique_id}.jpg"
        ...
        print(f"📷 تم حفظ صورة الباركود: {filename}")
        return filename
        
    except Exception as e:
        print(f"❌ خطأ في حفظ صورة الباركود: {str(e)}")
        return None
